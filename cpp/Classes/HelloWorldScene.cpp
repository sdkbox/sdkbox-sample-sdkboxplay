...
bool HelloWorld::init()
{
    ...
    this->addChild(Menu::create(quit, NULL));
    ...
    _txtStat = Label::createWithSystemFont("No action yet.", "Arial.ttf", defaultFontSize);
...
void HelloWorld::disconnect(cocos2d::Ref *sender) {
...
void HelloWorld::achievement_hunter(cocos2d::Ref *sender) {
    sdkbox::PluginSdkboxPlay::unlockAchievement("hunter");
}

void HelloWorld::achievement_ten_games(cocos2d::Ref *sender) {
