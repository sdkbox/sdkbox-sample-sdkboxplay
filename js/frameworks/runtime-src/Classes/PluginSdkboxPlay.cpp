#include "PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay.hpp"
#include "cocos2d_specifics.hpp"
#include "PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay/PluginSdkboxPlay.h"
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_signout(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_signout : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_incrementAchievement(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 2) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlay_PluginSdkboxPlay_incrementAchievement : Error processing arguments");
        sdkbox::PluginSdkboxPlay::incrementAchievement(arg0, arg1);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_incrementAchievement : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_showLeaderboard(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlay_PluginSdkboxPlay_showLeaderboard : Error processing arguments");
        sdkbox::PluginSdkboxPlay::showLeaderboard(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_showLeaderboard : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_isConnected(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_isConnected : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_showAchievements(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_showAchievements : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_signin(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_signin : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_init(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_init : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_submitScore(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 2) {
        ...
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        ok &= jsval_to_int32(cx, args.get(1), (int32_t *)&arg1);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlay_PluginSdkboxPlay_submitScore : Error processing arguments");
        sdkbox::PluginSdkboxPlay::submitScore(arg0, arg1);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_submitScore : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_unlockAchievement(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginSdkboxPlay_PluginSdkboxPlay_unlockAchievement : Error processing arguments");
        sdkbox::PluginSdkboxPlay::unlockAchievement(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_unlockAchievement : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_getVersion(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_getVersion : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginSdkboxPlay_PluginSdkboxPlay_removeListener(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginSdkboxPlay_PluginSdkboxPlay_removeListener : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
void js_PluginSdkboxPlay_PluginSdkboxPlay_finalize(JSFreeOp *fop, JSObject *obj) {
...
void js_register_PluginSdkboxPlay_PluginSdkboxPlay(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_sdkbox_PluginSdkboxPlay_class->finalize = js_PluginSdkboxPlay_PluginSdkboxPlay_finalize;
    ...
    static JSFunctionSpec st_funcs[] = {
        JS_FN("signout", js_PluginSdkboxPlay_PluginSdkboxPlay_signout, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("incrementAchievement", js_PluginSdkboxPlay_PluginSdkboxPlay_incrementAchievement, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("showLeaderboard", js_PluginSdkboxPlay_PluginSdkboxPlay_showLeaderboard, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("isConnected", js_PluginSdkboxPlay_PluginSdkboxPlay_isConnected, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("showAchievements", js_PluginSdkboxPlay_PluginSdkboxPlay_showAchievements, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("signin", js_PluginSdkboxPlay_PluginSdkboxPlay_signin, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("init", js_PluginSdkboxPlay_PluginSdkboxPlay_init, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("submitScore", js_PluginSdkboxPlay_PluginSdkboxPlay_submitScore, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("unlockAchievement", js_PluginSdkboxPlay_PluginSdkboxPlay_unlockAchievement, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("getVersion", js_PluginSdkboxPlay_PluginSdkboxPlay_getVersion, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("removeListener", js_PluginSdkboxPlay_PluginSdkboxPlay_removeListener, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
    };
...
void register_all_PluginSdkboxPlay(JSContext* cx, JS::HandleObject obj) {
    ...
    js_register_PluginSdkboxPlay_PluginSdkboxPlay(cx, ns);
...
void register_all_PluginSdkboxPlay(JSContext* cx, JSObject* obj) {
    ...
    js_register_PluginSdkboxPlay_PluginSdkboxPlay(cx, obj);
